...
audio_files = {'./Signals/Project_BirdRecognition/Task/F1.wav',...
    './Signals/Project_BirdRecognition/Task/F2.wav',... 
    './Signals/Project_BirdRecognition/Task/F3.wav',...
    './Signals/Project_BirdRecognition/Task/F4.wav',...
    './Signals/Project_BirdRecognition/Task/F5.wav',...
    './Signals/Project_BirdRecognition/Task/F6.wav',...
    './Signals/Project_BirdRecognition/Task/F7.wav',...
    './Signals/Project_BirdRecognition/Task/F8.wav'};
Fs = 0;
